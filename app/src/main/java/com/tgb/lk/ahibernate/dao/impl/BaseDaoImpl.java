...
public class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public final T findBySql(String sql, String... selectionArgs) {
        SQLiteDatabase db = null;
        Cursor cursor = null;
        try {
            db = this.dbHelper.getReadableDatabase();
    ...
    public final List<T> findBySql2List(String sql, String... selectionArgs) {
        List<T> list = new ArrayList<T>();
        SQLiteDatabase db = null;
        Cursor cursor = null;
        try {
    ...
    protected int update(String[] upColumnName, String[] upValue, String[] columnName, String... whereValue) {
        SQLiteDatabase db = null;
        try {
            db = this.dbHelper.getWritableDatabase();
            String w = "";
