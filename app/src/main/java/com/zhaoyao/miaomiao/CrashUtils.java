...
import com.zhaoyao.miaomiao.util.CloseUtils;
...
public final class CrashUtils implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, final Throwable throwable) {
        boolean permissionProhibit = isPermissionProhibit(ctx, Manifest.permission.WRITE_EXTERNAL_STORAGE);
...
//        ----------------------------------------------------------------------
     ...
     * @return 是否禁止
     */
    private  boolean isPermissionProhibit(@NonNull Context context, @NonNull String permission){
