...
public class BrushInterstitialActivity extends Activity implements SplashADListener {
    ...
    public void onNoAD(AdError error) {
        Log.i(
                ...
                String.format("LoadSplashADFail, eCode=%d, errorMsg=%s", error.getErrorCode(),
                        error.getErrorMsg()));
//        /** 如果加载广告失败，则直接跳转 */
//        this.startActivity(new Intent(this, com.zhaoyao.miaomiao.MainActivity.class));
        this.finish();
    }
